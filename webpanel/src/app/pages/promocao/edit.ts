...
declare var $: any;
@Component({
  selector: 'app-promocao-edit',
  templateUrl: './edit.html'
})
export class PromocaoEditComponent implements OnInit {
  ...
  *************/
  getItem() {
    this.ActivatedRoute.params.subscribe(params => {
      ...
      this.HttpService.JSON_GET(`/data/item/promocoes/${params.id}/*/titulo`, headerConfig)
        .then(
          (res) => {
  ...
  putItem(form) {
    this.ActivatedRoute.params.subscribe(params => {
      if (form.status === 'INVALID') {
        ...
        this.HttpService.JSON_PUT(`/data/item/promocoes/${params.id}/*/titulo`, headerConfig, form.value)//CADASTRO DE bannerS      
          .then(
            (res) => {
