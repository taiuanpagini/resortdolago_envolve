...
declare var $: any;
@Component({
  selector: 'app-promocao-upload',
  templateUrl: './upload.html'
})
export class PromocaoUploadComponent implements OnInit {
  ...
  uploadImgs() {
    ...
    this.ActivatedRoute.params.subscribe(params => {
      ...
      if (this.imgsSelecionadas === undefined || this.imgsSelecionadas === null) {
        ...
        formData.append('ref', 'promocoes');//REF DA IMAGEM (geral, blog, noticias, eventos, galeria...)
        ...
        this.HttpService.JSON_UPLOAD_POST(`/file/ftp/images/800/300/100/imagens/nome/idItem/ref/pathLarge/pathMedium/pathThumb`, headerConfig, formData)
          .then(
            (res) => {
              ...
              Promise.resolve(this.AlertService.alertLoadingClose(true))
                .then(() => {
                  ...
                  Promise.resolve(this.AlertService.alertInfo(res.json().msg))
                    .then(() => { this.Router.navigate(['/promocao/lista']); })
