...
declare var $: any;
@Component({
  selector: 'app-caldas-upload',
  templateUrl: './upload.html'
})
export class CaldasUploadComponent implements OnInit {
  ...
  uploadImgs() {
    ...
    this.ActivatedRoute.params.subscribe(params => {
      ...
      if (this.imgsSelecionadas === undefined || this.imgsSelecionadas === null) {
        ...
        formData.append('ref', 'caldas');//REF DA IMAGEM (geral, blog, noticias, eventos, galeria...)
        ...
        this.HttpService.JSON_UPLOAD_POST(`/file/ftp/images/1230/400/100/imagens/nome/idItem/ref/pathLarge/pathMedium/pathThumb`, headerConfig, formData)
          .then(
            (res) => {
              ...
              Promise.resolve(this.AlertService.alertLoadingClose(true))
                .then(() => {
                  ...
                  Promise.resolve(this.AlertService.alertInfo(res.json().msg))
                    .then(() => { this.Router.navigate(['/caldas-novas/lista']); })
