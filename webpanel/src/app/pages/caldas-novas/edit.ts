...
declare var $: any;
@Component({
  selector: 'app-caldas-edit',
  templateUrl: './edit.html'
})
export class CaldasEditComponent implements OnInit {
  ...
  *************/
  getItem() {
    this.ActivatedRoute.params.subscribe(params => {
      ...
      this.HttpService.JSON_GET(`/data/item/caldas/${params.id}/*/titulo`, headerConfig)
        .then(
          (res) => {
  ...
  putItem(form) {
    this.ActivatedRoute.params.subscribe(params => {
      if (form.status === 'INVALID') {
        ...
        this.HttpService.JSON_PUT(`/data/item/caldas/${params.id}/*/titulo`, headerConfig, form.value)//CADASTRO DE bannerS      
          .then(
            (res) => {
