...
declare var $: any;
@Component({
  selector: 'app-midia-new',
  templateUrl: './new.html'
})
export class MidiaNewComponent implements OnInit {
  ...
  *************/
  postItem(form) {
    ...
    if (form.status === 'INVALID') {
      ...
      this.HttpService.JSON_POST(`/data/midias/tipo`, headerConfig, form.value)//CADASTRO DE MIDIAS
        .then(
          (res) => {
